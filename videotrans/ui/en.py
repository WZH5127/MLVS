...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tts_type.setToolTip(
            '选择用来配音的渠道' if config.defaulelang == 'zh' else 'Select the channel used to dub')
        ...
        self.volume_rate.setToolTip(
            '音量增减的百分比' if config.defaulelang == 'zh' else "Percentage of volume adjustment")
        ...
        self.model_name_help.setToolTip(
            '点击查看模型选择说明' if config.defaulelang == 'zh' else 'Click for model description')
        ...
        self.hfaster_help.setToolTip(
            '点击打开该行参数填写帮助页面' if config.defaulelang == 'zh' else 'Click to open help page')
        ...
        self.max_speech_duration_s_label.setText(
            'max_speech_duration_s' if config.defaulelang != 'zh' else '最大语音持续时长')
        ...
        self.align_btn.setToolTip(
            "点击查看字幕、配音、画面对齐教程" if config.defaulelang == 'zh' else "View alignment tutorial")
    ...
    def retranslateUi(self):
        ...
        self.actionrecognapi.setText(
            "自定义语音识别API" if config.defaulelang == 'zh' else "Custom Speech Recognition API")
        ...
        self.action_subtitleediter.setText(
            '字幕编辑与翻译' if config.defaulelang == 'zh' else 'Subtitle Editing & Translate')
        ...
        self.actionsubtitlescover.setText(
            '字幕多格式转换' if config.defaulelang == 'zh' else 'Batch Subtitle Conversion')
